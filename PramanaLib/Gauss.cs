    ...
    IFormattable, IPramanaLinkable
{
    ...
    /// that are mathematically equal will always produce the same GUID.
    /// </summary>
    public Guid PramanaGuid => GenerateUuidV5(PramanaNamespace, $"{A},{B},{C},{D}");

    /// <summary>
    /// Gets the canonical Pramana pseudo-class identifier for this number, in the form
    /// <c>pra:num:A,B,C,D</c> (e.g. <c>"pra:num:1,1,0,1"</c> for 1,
    /// <c>"pra:num:3,1,2,1"</c> for 3+2i).
    /// </summary>
    public string PramanaId => $"pra:num:{A},{B},{C},{D}";
